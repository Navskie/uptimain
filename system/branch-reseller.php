       ...
       $employee = $get_country_fetch['users_employee'];  
        ...
        if(isset($_POST['reseller'])) {
            ...
            if ($newDate1 != '' && $newDate2 != '' && $res == '') {
                ...
                WHERE upti_reseller.reseller_country = '$employee' AND upti_activities.activities_caption = 'Order Delivered' AND
                ...
                $get_total_sales = "SELECT SUM(upti_order_list.ol_php) AS pinakatotal FROM upti_order_list INNER JOIN upti_activities ON upti_order_list.ol_poid = upti_activities.activities_poid WHERE upti_order_list.ol_country = '$employee' AND upti_activities.activities_caption = 'Order Delivered' AND upti_activities.activities_date BETWEEN '$date1' AND '$date2'";
                ...
                $sales_sql = "SELECT SUM(upti_order_list.ol_php) AS sales FROM upti_order_list INNER JOIN upti_activities ON upti_order_list.ol_poid = upti_activities.activities_poid WHERE upti_order_list.ol_country = '$employee' AND upti_order_list.ol_reseller = '$code' AND upti_activities.activities_caption = 'Order Delivered'";
                $sales_qry = mysqli_query($connect, $sales_sql);
                $sales_fetch = mysqli_fetch_array($sales_qry);

                $sales_sql1 = "SELECT SUM(upti_order_list.ol_php) AS saless FROM upti_order_list INNER JOIN upti_activities ON upti_order_list.ol_poid = upti_activities.activities_poid WHERE upti_order_list.ol_country = '$employee' AND upti_order_list.ol_seller = '$code' AND upti_activities.activities_caption = 'Order Delivered'";
                $sales_qry1 = mysqli_query($connect, $sales_sql1);
                $sales_fetch1 = mysqli_fetch_array($sales_qry1);

                $sales = $sales_fetch['sales'] + $sales_fetch['saless'];
            ...
            $number = 1;
                ...
                $sales_sql = "SELECT SUM(upti_order_list.ol_php) AS sales FROM upti_order_list INNER JOIN upti_activities ON upti_order_list.ol_poid = upti_activities.activities_poid  WHERE upti_order_list.ol_reseller = '$code' AND upti_order_list.ol_status = 'Delivered' AND upti_activities.activities_date BETWEEN '$date1' AND '$date2'";
                $sales_qry = mysqli_query($connect, $sales_sql);
                $sales_fetch = mysqli_fetch_array($sales_qry);

                $sales_sql1 = "SELECT SUM(upti_order_list.ol_php) AS saless FROM upti_order_list INNER JOIN upti_activities ON upti_order_list.ol_poid = upti_activities.activities_poid WHERE upti_order_list.ol_seller = '$code' AND upti_activities.activities_caption = 'Order Delivered'";
                $sales_qry1 = mysqli_query($connect, $sales_sql1);
                $sales_fetch1 = mysqli_fetch_array($sales_qry1);
                ...
                $sales = $sales_fetch['sales'] + $sales_fetch1['saless'];
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <select class="form-control select2bs4" style="width: 100%;" name="res">
                                            ...
                                            <?php
                                            $product_sql = "SELECT * FROM upti_users INNER JOIN upti_reseller ON upti_users.users_code = upti_reseller.reseller_code WHERE upti_reseller.reseller_country = '$employee' AND upti_users.users_role = 'UPTIRESELLER' AND upti_users.users_status = 'Active' ORDER BY upti_users.users_id DESC";
