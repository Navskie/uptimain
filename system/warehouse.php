        ...
        <div class="container-fluid">
            <div class="card rounded-0">
                <div class="card-body login-card-body text-dark">
                    <div class="row">
                        <div class="col-12">
                        <span class="float-left text-primary"><b>TAIWAN WAREHOUSE</b></span>

                        <a href="warehouse-ph.php" class="btn btn-primary btn-sm rounded-0 float-right">
                          PHILIPPINES
                        </a>
                        ...
                        <div class="col-12">
                            ...
                            <table id="example22" class="table table-bordered">
                                ...
                                <?php
                                  $code_sql = "SELECT * FROM stockist_warehouse WHERE warehouse_country = 'TAIWAN' ORDER BY warehouse_stocks ASC";
