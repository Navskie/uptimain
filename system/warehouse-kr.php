        ...
        <div class="container-fluid">
            <div class="card rounded-0">
                <div class="card-body login-card-body text-dark">
                    <div class="row">
                        <div class="col-12">
                        <span class="float-left text-primary"><b>KOREA WAREHOUSE</b></span>
                        ...
                        <div class="col-12">
                            ...
                            <table id="example22" class="table table-bordered">
                                ...
                                <?php
                                  $code_sql = "SELECT * FROM stockist_warehouse WHERE warehouse_country = 'KOREA' ORDER BY warehouse_stocks ASC";
