                ...
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <?php
                        ...
                        if ($country == 'CANADA' && $state == 'ALBERTA') {
                          $order_sql = "SELECT * FROM upti_transaction WHERE trans_status= 'Canceled' AND trans_country = '$country' AND trans_state = '$state' AND trans_date BETWEEN '$date1' AND '$date2' ORDER BY trans_poid DESC";
                        } elseif ($country == 'CANADA' && $state == 'ALL') {
                          $order_sql = "SELECT * FROM upti_transaction WHERE trans_status= 'Canceled' AND trans_country = '$country' AND trans_state = '$state' AND trans_date BETWEEN '$date1' AND '$date2' ORDER BY trans_poid DESC";
                        } else {
                          $order_sql = "SELECT * FROM upti_transaction WHERE trans_status= 'Canceled' AND trans_country = '$country' AND trans_date BETWEEN '$date1' AND '$date2' ORDER BY trans_poid DESC";
                        }
