                            ...
                            <table id="example1" class="table table-sm table-striped table-hover border border-info">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">DHL Information</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <?php
                                    $account = "SELECT * FROM stockist_request WHERE req_from = 'PHILIPPINES' AND req_status = 'On Process' ORDER BY id DESC";
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td class="text-center"><button type="submit" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#dhl<?php echo $account_fetch['req_reference'] ?>"><b>DHL Info</b></button></td>
                                    <td class="text-center">
