        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of My Direct Sales</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <?php
                        ...
                        $get_downline = "SELECT * FROM upti_users WHERE users_creator = '$mycode'";
                        $get_downline_qry = mysqli_query($connect, $get_downline);
                        while ($rows = mysqli_fetch_array($get_downline_qry)) {
                            $new_code = $rows['users_code'];
                            // echo '<br>';
                        

                        // $order_sql = "SELECT * FROM upti_transaction WHERE trans_seller = '$mycode' ORDER BY id DESC";
                        $order_sql = "SELECT * FROM upti_transaction WHERE trans_seller = '$new_code' ORDER BY trans_date DESC";
