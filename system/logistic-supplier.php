                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <table id="example22" class="table table-bordered">
                                ...
                                <?php
                                  $code_sql = "SELECT * FROM stockist_vendor WHERE vendor_location = 'PHILIPPINES' ORDER BY id DESC ";
                                ...
                                <tr>
                                  ...
                                  <td class="text-center" width="20"><a href="purchase-order-view2.php?po=<?php echo $code['vendor_po'] ?>" class="btn btn-sm btn-info rounded-0">VIEW</a></td>
