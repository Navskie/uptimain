    ...
    <?php
        ...
        if(isset($_POST['reseller'])) {
            ...
            if (empty($res)) {
                ...
                echo "<script>alert('All fields are required');window.location.href = 'reseller-sales.php';</script>";
               ...
               if ($newDate1 == '' && $newDate2 == '') {
                    $sales_sql = "SELECT SUM(upti_order_list.ol_php) AS sales FROM upti_order_list INNER JOIN upti_activities ON upti_order_list.ol_poid = upti_activities.activities_poid WHERE upti_order_list.ol_reseller = '$code'";
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <select class="form-control select2bs4" style="width: 100%;" name="res">
                                            ...
                                            <?php
                                            echo $product_sql = "SELECT * FROM upti_users WHERE users_creator = '$mycode' AND users_role = 'UPTIRESELLER' AND users_status = 'Active'";
