        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">RTS Orders</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <?php
                        ...
                        $order_sql = "SELECT * FROM upti_transaction WHERE trans_status = 'RTS' AND trans_my_reseller = '$mycode' ORDER BY trans_poid DESC";
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php if ($status == 'Pending') { ?>
                              <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#cancel<?php echo $order['id']; ?>" title="Cancel">Cancel</button>
                            <?php } else { echo '<span class="badge badge-danger">Action not Available</span>'; } ?>
                        </td>
                    </tr>
                    <?php
