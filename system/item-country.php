...
<?php include 'include/sidebar.php'; ?>
  ...
  <div class="content-wrapper" style="background: #f8f8f8 !important">
        ...
        <div class="container-fluid">
            <div class="card rounded-0">
                <div class="card-body login-card-body text-dark">
                    <div class="row">
                        <div class="col-12">
                        <span class="float-left text-primary"><b>Prices Per Country & Earnings</b></span>
                            ...
                            <table id="example1" class="table table-sm table-striped table-hover border border-info">
                              <thead>
                                <tr>
                                  ...
                                  <th class="text-center">Shop Price</th>
                                  <th class="text-center">Earnings Price</th>
                                  <th class="text-center">Stockist</th>
                                  <th class="text-center">Action</th>
                                </tr>
                              </thead>
                                <?php
                                  $country_sql = "SELECT * FROM upti_country ORDER BY id DESC";
                                  $country_qry = mysqli_query($connect, $country_sql);
                                  $number = 1;
                                  while ($country = mysqli_fetch_array($country_qry)) {
                                    $price = $country['country_price'];
                                    $prices = $country['country_total_php'];
                                    $pricess = $country['country_stockist'];
                                ?>
                                <tr>
                                  <td class="text-center"><?php echo $number; ?></td>
                                  <td class="text-center"><?php echo $country['country_name'] ?></td>
                                  <td class="text-center"><?php echo $country['country_code'] ?></td>
                                  <td class="text-center"><?php echo number_format($price) ?></td>
                                  <td class="text-center"><?php echo number_format($prices) ?></td>
                                  <td class="text-center"><?php echo number_format($pricess) ?></td>
                                ...
                                <?php
                                  include 'backend/country-edit-modal.php';
                                  include 'backend/country-delete-modal.php';
                                  $number++;
                                  }
                                ?>
                            </table>
    ...
    <?php include 'backend/country-add-modal.php' ?>
  </div>
