<div class="modal fade" id="remove<?php echo $rows['id']; ?>">
    <div class="modal-dialog modal-dialog-centered" style="border-radius: 0px !important;">
        <div class="modal-content bg-danger">
            ...
            <a class="btn btn-warning" style="border-radius: 0px !important;" href="backend/po-remove-process.php?id=<?php echo $rows['id']; ?>">Remove</a>
            </div>
        </div>
    </div>
</div>