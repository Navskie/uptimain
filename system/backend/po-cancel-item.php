    ...
    <div class="modal-dialog modal-dialog-centered" style="border-radius: 0px !important;">
        <div class="modal-content bg-danger">
            ...
            <div class="modal-body">
                <p>Are you sure you want to remove this <?php echo $rows['req_reference']; ?>?</p>
            </div>
            <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal" style="border-radius: 0px !important;">Close</button>
            <a class="btn btn-warning" style="border-radius: 0px !important;" href="backend/po-cancel-process.php?id=<?php echo $rows['id']; ?>">Proceed</a>
            </div>
        </div>
    </div>
</div>