<div class="modal fade" id="view<?php echo $account_fetch['req_reference']; ?>">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-12">
                    <img src="./images/stockist/<?php echo $account_fetch['req_img']; ?>" alt="" class="img-fluid" id="upload-img">
                </div>
            </div>
        </div>
