                        ...
                        <div class="col-12">
                            ...
                            <table id="example1" class="table table-sm table-striped table-hover border border-info">
                                ...
                                <?php
                                  ...
                                  $order_sql = "SELECT DISTINCT trans_fname, trans_lname, trans_country, trans_address, trans_contact, id FROM upti_transaction WHERE trans_seller = '$mycode' GROUP BY trans_lname, trans_fname ORDER BY id DESC";
