...
<div id="page-content">     
    ...
    <div class="container">
        ...
        WHERE code_category = 'PROMO' AND items_status = 'Active' AND p_tag = 'Promo' OR
        code_category = 'REBATABLE' AND items_status = 'Active' AND p_tag = 'Promo' OR
        code_category = 'BUY ONE GET ANY' AND items_status = 'Active' AND p_tag = 'Promo' OR
        code_category = 'BUY ONE GET TWO' AND items_status = 'Active' AND p_tag = 'Promo'  
        UNION 
        SELECT package_stamp, code_name, package_desc, package_status FROM upti_code 
        INNER JOIN upti_package ON upti_code.code_name = upti_package.package_code
        INNER JOIN upti_product ON upti_code.code_name = upti_product.p_code
        WHERE code_category = 'PROMO' AND package_status = 'Active' AND p_tag = 'Promo' OR
        code_category = 'REBATABLE' AND package_status = 'Active' AND p_tag = 'Promo' OR
        code_category = 'BUY ONE GET ANY' AND package_status = 'Active' AND p_tag = 'Promo' OR
        code_category = 'BUY ONE GET TWO' AND package_status = 'Active' AND p_tag = 'Promo' 
        ORDER BY items_created DESC
